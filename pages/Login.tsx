  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] px-4 relative">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg w-full max-w-md border-t-4 border-brasil-green overflow-hidden mt-12 md:mt-0 transition-colors duration-300">
                    ...
                    <>
                        <div className="relative animate-in fade-in slide-in-from-top-1">
                            ...
                            <input
                                ...
                                className={`block w-full pl-10 pr-10 py-3 border bg-gray-700 rounded-lg focus:ring-2 outline-none transition-all placeholder-gray-400 text-white ${
        ...
        {/* Footer Decoration */}
        <div className="bg-gray-50 dark:bg-gray-700 p-4 border-t border-gray-100 dark:border-gray-600 flex justify-center gap-2">
