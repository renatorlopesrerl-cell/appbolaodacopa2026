...
export const LeagueDetails: React.FC = () => {
    ...
    const renderClassificacaoTab = () => {
        ...
        const leaderboard = league.participants.map(userId => {
            ...
            let totalPoints = 0, exactScores = 0, winnerAndDiffCount = 0, knockoutPoints = 0;
            userPreds.forEach(p => {
                ...
                if (match) {
                    ...
                    else if (leaderboardView === 'oitavas' && match.phase === Phase.ROUND_16) includeInSum = true;
                    else if (leaderboardView === 'final_phase' && (match.phase === Phase.QUARTER || match.phase === Phase.SEMI || match.phase === Phase.FINAL)) includeInSum = true;
            ...
            return { user, totalPoints, exactScores, winnerAndDiffCount, knockoutPoints };
        }).sort((a, b) => {
