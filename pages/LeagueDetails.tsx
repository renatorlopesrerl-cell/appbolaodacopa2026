...
export const LeagueDetails: React.FC = () => {
            ...
            <div className="space-y-6 pb-24">
                ...
                <div className="flex flex-col gap-4 pt-2">
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex flex-wrap gap-1 md:gap-2 pb-1">
                            <button onClick={() => setFilterStatus('all')} className={`px-2 py-1 md:px-4 md:py-2 rounded-full text-[11px] md:text-xs font-bold transition-all border whitespace-nowrap ${filterStatus === 'all' ? 'bg-gray-800 text-white border-gray-800 shadow-md' : 'bg-white dark:bg-gray-700 text-gray-500 dark:text-gray-300 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600'}`}>Todos</button>
                            <button onClick={() => setFilterStatus('live')} className={`px-2 py-1 md:px-4 md:py-2 rounded-full text-[11px] md:text-xs font-bold transition-all border whitespace-nowrap flex items-center gap-1 ${filterStatus === 'live' ? 'bg-red-600 text-white border-red-600 shadow-md animate-pulse' : 'bg-white dark:bg-gray-700 text-gray-500 dark:text-gray-300 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600'}`}><Zap size={11} fill="currentColor" className="md:w-3 md:h-3" /> Ao Vivo</button>
                            <button onClick={() => setFilterStatus('finished')} className={`px-2 py-1 md:px-4 md:py-2 rounded-full text-[11px] md:text-xs font-bold transition-all border whitespace-nowrap flex items-center gap-1 ${filterStatus === 'finished' ? 'bg-blue-800 text-white border-blue-800 shadow-md' : 'bg-white dark:bg-gray-700 text-gray-500 dark:text-gray-300 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600'}`}><CheckCircle2 size={11} className="md:w-3 md:h-3" /> Finalizados</button>
                            <button onClick={() => setFilterStatus('missing')} className={`px-2 py-1 md:px-4 md:py-2 rounded-full text-[11px] md:text-xs font-bold transition-all border whitespace-nowrap flex items-center gap-1 ${filterStatus === 'missing' ? 'bg-red-500 text-white border-red-500 shadow-md' : 'bg-white dark:bg-gray-700 text-gray-500 dark:text-gray-300 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600'}`}><AlertCircle size={11} className="md:w-3 md:h-3" /> Pendentes</button>
                            <button onClick={() => setFilterStatus('predicted')} className={`px-2 py-1 md:px-4 md:py-2 rounded-full text-[11px] md:text-xs font-bold transition-all border whitespace-nowrap flex items-center gap-1 ${filterStatus === 'predicted' ? 'bg-green-600 text-white border-green-600 shadow-md' : 'bg-white dark:bg-gray-700 text-gray-500 dark:text-gray-300 border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600'}`}><CheckCircle2 size={11} className="md:w-3 md:h-3" /> Preenchidos</button>
                        </div>
    ...
    return (
        <div>
            ...
            <div className="flex flex-wrap gap-1 bg-gray-200 dark:bg-gray-700 p-1 rounded-lg mb-6 shadow-inner">
                <button onClick={() => setActiveTab('palpites')} className={`flex-1 py-1.5 md:py-2 px-1 md:px-4 rounded-md text-xs md:text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'palpites' ? 'bg-white dark:bg-gray-600 shadow text-brasil-blue dark:text-blue-300 translate-y-[1px]' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'}`}>Palpites</button>
                <button onClick={() => setActiveTab('classificacao')} className={`flex-1 py-1.5 md:py-2 px-1 md:px-4 rounded-md text-xs md:text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'classificacao' ? 'bg-white dark:bg-gray-600 shadow text-brasil-blue dark:text-blue-300 translate-y-[1px]' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'}`}>Classificação</button>
                <button onClick={() => setActiveTab('regras')} className={`flex-1 py-1.5 md:py-2 px-1 md:px-4 rounded-md text-xs md:text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'regras' ? 'bg-white dark:bg-gray-600 shadow text-brasil-blue dark:text-blue-300 translate-y-[1px]' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'}`}>Regras</button>
                {isAdmin && <button onClick={() => setActiveTab('admin')} className={`flex-1 py-1.5 md:py-2 px-1 md:px-4 rounded-md text-xs md:text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'admin' ? 'bg-white dark:bg-gray-600 shadow text-brasil-blue dark:text-blue-300 translate-y-[1px]' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'}`}>Admin {validPendingRequestsCount > 0 && <span className="ml-1 w-1.5 h-1.5 inline-block bg-red-500 rounded-full"></span>}</button>}
            </div>
