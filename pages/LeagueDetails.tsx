...
export const LeagueDetails: React.FC = () => {
    ...
    return (
        <div>
            ...
            <div className="flex flex-wrap gap-1 bg-gray-200 dark:bg-gray-700 p-1 rounded-lg mb-6">
