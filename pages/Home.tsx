...
export const Home: React.FC = () => {
  const { currentUser, matches, leagues, currentTime, loading, invitations, respondToInvite } = useStore();
         ...
         <div className="flex flex-col items-center justify-center min-h-[75vh] text-center animate-in fade-in zoom-in-95 duration-500 pb-10">
             ...
             <div className="w-full max-w-xs space-y-4 mt-10">
                 ...
                 >
                    ...
                    <span className="text-sm md:text-base uppercase tracking-wide">ENTRAR OU CADASTRAR</span>
                 </Link>
